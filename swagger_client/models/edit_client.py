...
class EditClient(object):
    ...
    def __init__(self, id=None, legal_name=None, commercial_name=None, rfc=None, credit_days=None, credit_amount=None, payment_method=None, payment_term=None, location_id=None, sales_employee_id=None, credit_employee_id=None, price_list_id=None, comment=None, telephone=None, email=None, account_number=None, default_discount=None, source=None, accounting_number=None):  # noqa: E501
