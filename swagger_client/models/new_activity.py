...
class NewActivity(object):
    ...
    def __init__(self, external_id=None, external_id_type=None, comment=None, start_date=None, end_date=None, event_type=None, is_public=None, title=None, repeatable=None, repeat_interval=None, repeat_type=None, repetitions=None):  # noqa: E501
