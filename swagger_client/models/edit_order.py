...
class EditOrder(object):
    ...
    def __init__(self, id=None, address_id=None, client_id=None, comments=None, currency_id=None, discount_amount=None, discount_type=None, doc_number_id=None, exchange_rate=None, isr_rate=None, location_id=None, order_date=None, price_list_id=None, purchase_order=None, vat_rate=None, vat_ret_rate=None, warehouse_id=None, emails=None, products=None, services=None):  # noqa: E501
