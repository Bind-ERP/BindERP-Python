...
class NewPayment(object):
    ...
    def __init__(self, invoice_id=None, account_id=None, date=None, reference=None, amount=None, payment_term=None, comments=None, exchange_rate=None, exchange_rate_account=None):  # noqa: E501
